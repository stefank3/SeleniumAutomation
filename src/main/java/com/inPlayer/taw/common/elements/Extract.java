...
public class Extract extends ElementBase {
    ...
    public WebElement element(final By by) {
        return Global.waitElement.until(ExpectedConditions.visibilityOfElementLocated(by));
    }
    ...
    public List<WebElement> allElements(final By by) {
        return Global.waitElement.until(ExpectedConditions.visibilityOfAllElementsLocatedBy((by)));
    }
