...
public class Misc extends ElementBase {
    ...
    public void dragDrop(final By sourceLocator, final By destinationLocator) {
        try {
            (new Actions(Global.driver)).dragAndDrop(getElement(sourceLocator), getElement(destinationLocator)).perform();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void dragDrop(final By sourceLocator, final int sourceIndex, final By destinationLocator,
        ...
        try {
            (new Actions(Global.driver)).dragAndDrop(getAllElements(sourceLocator).get(sourceIndex),
